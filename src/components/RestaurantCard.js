...
function RestaurantCard({
  ...
  return (
    <div className="relative m-8 hover:bg-[#f6d3b3] duration-300 hover:scale-110 hover:shadow-[#fb6c3c] h-80 w-60 shadow-2xl rounded-lg overflow-hidden border border-[#f9cea6]">
