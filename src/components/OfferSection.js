...
const OfferSection = ({ restaurant }) => {
  ...
  return (
    <div className="p-3 pt-4 mt-6 bg-[#f3c5c5] text-center border border-gray-200 rounded-lg ">
      ...
      <div className="font-semibold  flex justify-center p-2 m-2">
        {offers.map(({ info }) => (
          ...
          >
            <div className="flex flex-col items-center justify-center p-4 h-full w-full bg-[#e08c8c] rounded-lg ">
              <img
              ...
              <div className="text-xs text-black hover:scale-110 duration-300 bg-[#f3c5c5] border border-gray-400 rounded-full m-1 px-2 py-2 ">
