...
const ContactUsPage = () => {
  ...
  const form = (
    <>
      <h1 className="text-3xl font-bold mb-8 text-[#fb6c3c]">Contact Us</h1>
      <form className="py-4 max-w-lg w-full" onSubmit={handleFormSubmit}>
        ...
        <div className="flex justify-center">
          <Button className="hover:scale-110 duration-300 mx-2 px-10 hover:bg-[#c74f27] bg-[#fb6c3c] text-white">
            Submit
          </Button>
        </div>
      </form>
  ...
  const formSubmissionConfirmationBox = (
    <div className="h-96 rounded-lg shadow-lg p-4 my-4 bg-[#E97171] flex flex-col items-center justify-center">
      ...
      <p>
        ...
        <span className="font-semibold text-[#fb6c3c]">{emailAddress}</span>
      </p>
